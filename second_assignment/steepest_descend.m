...
saveas(gcf, [pwd '/figs/sd_const_step_zero.png']);
...
saveas(gcf, [pwd '/figs/sd_const_step_zero_iter_fval.png']);
...
saveas(gcf, [pwd '/figs/sd_const_step_one.png']);
...
xlabel("iteration no");
ylabel("function value");
saveas(gcf, [pwd '/figs/sd_const_step_one_iter_fval.png']);
...
saveas(gcf, [pwd '/figs/sd_const_step_two.png']);
figure("Name", "f value at each iteration, constant step = 0.005, starting point = (1, -1)");
size_zr = size(points_two_const);
plot(1:size_zr(1), f(points_two_const(:, 1), points_two_const(:, 2)));
xlabel("iteration no");
ylabel("function value");
saveas(gcf, [pwd '/figs/sd_const_step_two_iter_fval.png']);
...
saveas(gcf, [pwd '/figs/sd_min_step_zero.png']);
...
xlabel("iteration no");
ylabel("function value");
saveas(gcf, [pwd '/figs/sd_min_step_zero_iter_fval.png']);
...
saveas(gcf, [pwd '/figs/sd_min_step_one.png']);
...
xlabel("iteration no");
ylabel("function value");
saveas(gcf, [pwd '/figs/sd_min_step_one_iter_fval.png']);
...
saveas(gcf, [pwd '/figs/sd_min_step_two.png']);
figure("Name", "f value at each iteration, minimizing step, starting point = (1, -1)");
size_zr = size(points_two_min);
plot(1:size_zr(1), f(points_two_min(:, 1), points_two_min(:, 2)));
xlabel("iteration no");
ylabel("function value");
saveas(gcf, [pwd '/figs/sd_min_step_two_iter_fval.png']);
...
saveas(gcf, [pwd '/figs/sd_arm_step_zero.png']);
...
xlabel("iteration no");
ylabel("function value");
saveas(gcf, [pwd '/figs/sd_arm_step_zero_iter_fval.png']);
...
saveas(gcf, [pwd '/figs/sd_arm_step_one.png']);
...
xlabel("iteration no");
ylabel("function value");
saveas(gcf, [pwd '/figs/sd_arm_step_one_iter_fval.png']);
...
saveas(gcf, [pwd '/figs/sd_arm_step_two.png']);
figure("Name", "f value at each iteration, armijo's rule step, starting point = (1, -1)");
size_zr = size(points_two_arm);
plot(1:size_zr(1), f(points_two_arm(:, 1), points_two_arm(:, 2)));
xlabel("iteration no");
ylabel("function value");
saveas(gcf, [pwd '/figs/sd_arm_step_two_iter_fval.png']);
