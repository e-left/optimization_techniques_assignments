...
ylabel("iterations");
legend("f1", "f2", "f3");
saveas(gcf, [pwd '/figs/bicection_derivative/iterations_l.png']);
...
ylabel("calculations");
legend("f1", "f2", "f3");
saveas(gcf, [pwd '/figs/bicection_derivative/calculations_l.png']);
...
saveas(gcf, [pwd '/figs/bicection_derivative/search_limits_0005.png']);
...
ylabel("function value");
legend("lower(f1)", "upper(f1)", "lower(f2)", "upper(f2)", "lower(f3)", "upper(f3)");
saveas(gcf, [pwd '/figs/bicection_derivative/search_limits_001.png']);
...
ylabel("function value");
legend("lower(f1)", "upper(f1)", "lower(f2)", "upper(f2)", "lower(f3)", "upper(f3)");
saveas(gcf, [pwd '/figs/bicection_derivative/search_limits_01.png']);
